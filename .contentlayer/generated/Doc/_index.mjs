...
import docs__relay__genProt__excLossMdx from './docs__relay__gen.-prot.__exc.-loss.mdx.json' assert { type: 'json' }
import docs__relay__genProt__indexMdx from './docs__relay__gen.-prot.__index.mdx.json' assert { type: 'json' }
import docs__relay__genProt__reversePowerMdx from './docs__relay__gen.-prot.__reverse-power.mdx.json' assert { type: 'json' }
import docs__relay__genProt__statorEfMdx from './docs__relay__gen.-prot.__stator-ef.mdx.json' assert { type: 'json' }
import docs__relay__motorProt__indexMdx from './docs__relay__motor-prot.__index.mdx.json' assert { type: 'json' }
import docs__relay__motorProt__stallProtMdx from './docs__relay__motor-prot.__stall-prot..mdx.json' assert { type: 'json' }
