...
The pickup value is the minimum current at which the relay starts to operate. It is usually expressed as a multiple of the nominal current or as a percentage of the relay's setting range. Accurate pickup settings are essential for:

- Ensuring coordination with other protective devices
- Preventing nuisance tripping during normal load conditions
- Providing adequate protection during fault conditions
- Maintaining compliance with protection system design specifications
...
2. **Relay Under Test**: Overcurrent protection relay (examples):
   - Electromechanical: GE IAC, Westinghouse CO
   - Digital: ABB REF615, Siemens 7SJ62, SEL-751
   - Microprocessor-based: GE Multilin 750/760, Schneider Electric P14D
